...
dropdownData = pd.read_csv("febDataPerLocation2.csv")  # creating a df from pedstats
...
dff_average = pd.read_csv("febDataPerLocation2.csv")  # creating a df to find average apd for all locations
